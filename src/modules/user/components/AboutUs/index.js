                ...
                <Stack
                    ...
                    <Stack flex={1} spacing={{ base: 5, md: 10 }}>
                        <Heading
                            ...
                            <Text as={'span'} position={'relative'}>Empowering the world to develop technology through collective knowledge.</Text>
                            <br />
                        </Heading>
                        <Text color={'gray.500'} >
                            Our public platform serves alot of users every day, making it one of the most popular websites in the world.
                            <br />
